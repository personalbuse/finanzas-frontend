  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center py-12 px-4 animate-fade-in">
      <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-2xl border border-slate-200 shadow-sm">
        ...
        {step === 1 && (
          <form className="mt-8 space-y-5" onSubmit={handleSubmitStep1}>
            <div>
        ...
        {step === 2 && (
          <form className="mt-8 space-y-5" onSubmit={handleVerifyCode}>
            ...
            <div>
              <label htmlFor="verificationCode" className="text-[10px] font-bold text-slate-400 uppercase tracking-widest ml-1">
              ...
              <input
                ...
                maxLength={6}
                required
                className="input-clean mt-1 text-center text-2xl tracking-widest font-mono"
                placeholder="000000"
